...
plt.ylabel ('Count')
plt.savefig("../figures/fig1_survival_status_count.png")
plt.close()
...
plt.savefig("../figures/fig2_tumor_grade_distribution.png")
plt.close()
...
plt.savefig("../figures/fig3_km_curve_overall.png")
plt.close()
...
# Save plot
plt.savefig("../figures/fig4_km_curve_mutation_vs_no_mutation.png")
plt.close()
...
# Save plot
plt.savefig("../figures/fig5_km_curve_by_mutation.png")
plt.close()
...
# Save plot
plt.savefig("../figures/fig6_km_curve_by_metastatic_site.png")
plt.close()
...
# Show plot
plt.savefig("../figures/fig7_km_curve_by_tumor_subtype.png")
plt.close()
